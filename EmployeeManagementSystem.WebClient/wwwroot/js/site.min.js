 ...
 */
(function(n){typeof define=="function"&&define.amd?define(["jquery","datatables.net"],function(t){return n(t,window,document)}):typeof exports=="object"?module.exports=function(t,i){return t||(t=window),i&&i.fn.dataTable||(i=require("datatables.net")(t,i).$),n(i,t,t.document)}:n(jQuery,window,document)})(function(n,t,i,r){"use strict";var u=n.fn.dataTable;return n.extend(!0,u.defaults,{dom:"<'row'<'col-sm-12 col-md-6'l><'col-sm-12 col-md-6'f>><'row'<'col-sm-12'tr>><'row'<'col-sm-12 col-md-5'i><'col-sm-12 col-md-7'p>>",renderer:"bootstrap"}),n.extend(u.ext.classes,{sWrapper:"dataTables_wrapper dt-bootstrap4",sFilterInput:"form-control form-control-sm",sLengthSelect:"custom-select custom-select-sm form-control form-control-sm",sProcessing:"dataTables_processing card",sPageButton:"paginate_button page-item"}),u.ext.renderer.pageButton.bootstrap=function(t,f,e,o,s,h){var y=new u.Api(t),b=t.oClasses,a=t.oLanguage.oPaginate,k=t.oLanguage.oAria.paginate||{},c,l,p=0,w=function(i,r){for(var v,u,d=function(t){t.preventDefault();n(t.currentTarget).hasClass("disabled")||y.page()==t.data.action||y.page(t.data.action).draw("page")},f=0,o=r.length;f<o;f++)if(u=r[f],n.isArray(u))w(i,u);else{c="";l="";switch(u){case"ellipsis":c="&#x2026;";l="disabled";break;case"first":c=a.sFirst;l=u+(s>0?"":" disabled");break;case"previous":c=a.sPrevious;l=u+(s>0?"":" disabled");break;case"next":c=a.sNext;l=u+(s<h-1?"":" disabled");break;case"last":c=a.sLast;l=u+(s<h-1?"":" disabled");break;default:c=u+1;l=s===u?"active":""}c&&(v=n("<li>",{"class":b.sPageButton+" "+l,id:e===0&&typeof u=="string"?t.sTableId+"_"+u:null}).append(n("<a>",{href:"#","aria-controls":t.sTableId,"aria-label":k[u],"data-dt-idx":p,tabindex:t.iTabIndex,"class":"page-link"}).html(c)).appendTo(i),t.oApi._fnBindAction(v,{action:u},d),p++)}},v;try{v=n(f).find(i.activeElement).data("dt-idx")}catch(d){}w(n(f).empty().html('<ul class="pagination"/>').children("ul"),o);v!==r&&n(f).find("[data-dt-idx="+v+"]").focus()},u});var PageElementHelpers=function(){var n=function(n,t,i){$(n).hover(function(){$(t).is(":hidden")&&$(i).show()},function(){$(i).hide()})},t=function(n,t,i){$(n).on("click",function(){$(n).hide();$(t).css({display:"none"});$(i).css({display:"inline-block"});$(i).focus();$(i).val($(t).html())})},i=function(n,t){$(n).focusout(function(){$(t).html($(n).val());$(n).css({display:"none"});$(t).css({display:"inline-block","margin-top":"2px"})})},r=function(n,t,i){$(n).change(function(){$(t).show();$(i).show()})},u=function(n,t){var i=bootbox.dialog({message:"<span style='color: "+n+"'>"+t+"<\/span>",closeButton:!1,centerVertical:!0});setTimeout(function(){i.modal("hide")},2e3)},f=function(n,t){return bootbox.dialog({centerVertical:!0,title:"! Delete !",message:"<p>After deletion, "+n+" will not be available. Do you still want to delete? <\/p>",size:"large",buttons:{cancel:{label:"Cancel",className:"btn-info",callback:function(){}},ok:{label:"Delete",className:"btn-danger",callback:t}}})};return{toggleEditIcon:n,onClickEditIcon:t,onEditUnfocus:i,onInputChange:r,toggleModal:u,deleteToggleModal:f}}(),JobService=function(){var n=function(n,t){$.ajax({url:"http://localhost:5001/api/jobs",method:"GET"}).then(n).fail(t)};return{getJobs:n}}(),SkillService=function(){var n=function(n,t){$.ajax({url:"http://localhost:5001/api/skills/",method:"GET"}).then(n).fail(t)},t=function(n,t){return{url:"http://localhost:5001/api/skills/?type="+n+"&status="+t,dataSrc:""}},i=function(n){return{url:"http://localhost:5001/api/jobs/"+n+"/skills",dataSrc:"",headers:{Accept:"application/json"}}},r=function(n,t,i){$.ajax({url:"http://localhost:5001/api/skillsByName/?skillNames="+n,method:"GET"}).then(t).fail(i)},u=function(n,t,i){$.ajax({url:"http://localhost:5001/api/skills/"+n,method:"GET"}).then(t).fail(i)},f=function(n){var t,i;$("#inputType").change(function(){var i=$("#inputType").find(":selected").text(),t={op:"replace",path:"/type",value:i};n.find(n=>n===t)||n.push(t)});$("#inputName").change(function(){var i=$("#inputName").val(),t={op:"replace",path:"/name",value:i};n.find(n=>n===t)||n.push(t)});$("#inputDescription").change(function(){var i=$("#inputDescription").val(),t={op:"replace",path:"/description",value:i};n.find(n=>n===t)||n.push(t)});t=[];$(".form-check input:checkbox:checked").map(function(){t.push({jobId:$(this).data("id")})});i={op:"replace",path:"/jobSkills",value:t};n.find(n=>n===i)||n.push(i)},e=function(n){var i=[],t;$(".form-check input:checkbox:checked").map(function(){i.push({jobId:$(this).data("id")})});t={op:"replace",path:"/jobSkills",value:i};n.find(n=>n===t)||n.push(t)},o=function(){return[{op:"replace",path:"/isEnabled",value:!1}]},s=function(){return[{op:"replace",path:"/isEnabled",value:!0}]},h=function(n,t,i,r){$.ajax({type:"PATCH",url:"http://localhost:5001/api/skills/"+n,data:JSON.stringify(t),processData:!1,contentType:"application/json-patch+json"}).then(i,r)},c=function(n,t){var i=[],r;$(".form-check input:checkbox:checked").map(function(){i.push({jobId:$(this).data("id")})});r={type:$("#postType").find(":selected").text(),name:$("#postName").val(),description:$("#postDescription").val(),isEnabled:!0,jobSkills:i};$.ajax({type:"POST",url:"http://localhost:5001/api/skills/",data:JSON.stringify(r),contentType:"application/json"}).then(n,t)},l=function(n,t,i){$.ajax({type:"POST",url:"http://localhost:5001/api/skillcollections/",data:JSON.stringify(n),contentType:"application/json"}).then(t,i)},a=function(n,t,i){$.ajax({type:"DELETE",url:"http://localhost:5001/api/skills/"+n}).then(t,i)};return{getSkills:n,getAllSkillsDatatable:t,getSkillsForJobDatatable:i,getSkillsByName:r,getSkill:u,getSkillPatchDocument:f,getSkillDisablePatchDocument:o,getSkillEnablePatchDocument:s,getJobSkillsPatchDocument:e,patchSkill:h,postSkill:c,postSkillCollection:l,deleteSkill:a}}(),EmployeeService=function(){var n=function(n){return{url:"http://localhost:5001/api/employees?skillguids="+n,dataSrc:""}},t=function(n){var t=[];return $("#allEmployees").dataTable().$("tr.selected").each(function(){var i=n.row(this).data();t.push(i.id)}),t.join()},i=function(n,t,i){$(".form-check input:checkbox:checked").map(function(){typeof $(this).data("id")!="undefined"&&n.push({skillId:$(this).data("id")})});var r={name:$("#postEmpName").val(),surname:$("#postEmpSurname").val(),jobId:$("#postEmpJob").find(":selected").data("id"),hiringDate:$("#postHiringDate").val(),phoneNumber:$("#postEmpPhone").val(),email:$("#postEmpEmail").val(),employeeSkills:n};$.ajax({type:"POST",url:"http://localhost:5001/api/employees/",data:JSON.stringify(r),contentType:"application/json"}).then(t,i)},r=function(n){var t,i;$("#inputEmpName").change(function(){var i=$("#inputEmpName").val(),t={op:"replace",path:"/name",value:i};n.find(n=>n===t)||n.push(t)});$("#inputEmpSurname").change(function(){var i=$("#inputEmpSurname").val(),t={op:"replace",path:"/surname",value:i};n.find(n=>n===t)||n.push(t)});$("#inputEmpPhone").change(function(){var i=$("#inputEmpPhone").val(),t={op:"replace",path:"/phoneNumber",value:i};n.find(n=>n===t)||n.push(t)});$("#inputEmpEmail").change(function(){var i=$("#inputEmpEmail").val(),t={op:"replace",path:"/email",value:i};n.find(n=>n===t)||n.push(t)});t=[];$(".form-check input:checkbox:checked").map(function(){t.push({skillId:$(this).data("id")})});i={op:"replace",path:"/employeeSkills",value:t};n.find(n=>n===i)||n.push(i)},u=function(n){var i=[],t;$(".form-check input:checkbox:checked").map(function(){i.push({skillId:$(this).data("id")})});t={op:"replace",path:"/employeeSkills",value:i};n.find(n=>n===t)||n.push(t)},f=function(n,t,i,r){$.ajax({type:"PATCH",url:"http://localhost:5001/api/employees/"+n,data:JSON.stringify(t),processData:!1,contentType:"application/json-patch+json"}).then(i,r)},e=function(n,t,i){$.ajax({url:"http://localhost:5001/api/employeecollections?ids="+n,method:"DELETE"}).then(t).fail(i)},o=function(n,t,i){$.ajax({type:"DELETE",url:"http://localhost:5001/api/employees/"+n}).then(t,i)};return{getAllEmployeesDatatable:n,getSelectedEmployeesIds:t,postEmployee:i,getEmployeePatchDocument:r,getEmployeeSkillsPatchDocument:u,patchEmployee:f,deleteEmployeesCollection:e,deleteEmployee:o}}(),SkillsController=function(n,t,i){var r=function(n){var i=function(t){var i="";$.each(t,function(n){i+='<option value="'+t[n].id+'">'+t[n].seniorityLevel+" "+t[n].title+"<\/option>"});$(n).html(i)},r=function(){alert("Something failed!")};t.getJobs(i,r)},u=function(n,t){$("#searchJob").on("change",function(){var i=$("#searchJob option:selected").attr("value");n.destroy();n=SkillsController.skillsInit("#skills",i,t)})},f=function(n,t,r,u){$(n).DataTable({ajax:i.getAllSkillsDatatable(r,u),columns:[{data:"name",render:function(n,i,r){return'<a href="'+t+"/"+r.id+'">'+n+"<\/a>"}},{data:"type"},{data:"description"},{data:"isEnabled",render:function(n){return n?'<i class="fas fa-check" style="color:green;"><\/i>':'<i class="fas fa-times" style="color:red;"><\/i>'}}],dom:"Bfrtip",buttons:["copyHtml5","excelHtml5","csvHtml5","pdfHtml5"]})},e=function(n,t,r){return $(n).DataTable({ajax:i.getSkillsForJobDatatable(t),columns:[{data:"name",render:function(n,t,i){return'<a href="'+r+"/"+i.id+'">'+n+"<\/a>"}},{data:"type"},{data:"description"}]})},o=function(n,t,r,u,f){var e=function(i){$(n).html(i.type);$(t).html(i.name);$(r).append(i.description);$(u).html(i.creationDate)},o=function(){alert("Something failed!")};i.getSkill(f,e,o)},s=function(){var t=function(){n.toggleModal("green","Skill created")},r=function(t,i,r){n.toggleModal("red","Skill not created!"+r)};$("#submitSkillForm").click(function(){i.postSkill(t,r);setTimeout(function(){window.location.href="https://localhost:44375/Skills/AllSkills"},2500)})};return{jobsInit:r,jobsDropdownOnChange:u,allSkillsInit:f,skillsInit:e,skillInit:o,createSkill:s}}(PageElementHelpers,JobService,SkillService),SkillDetailsController=function(n,t){var i=function(n){r();u();f();e(n)},r=function(){n.toggleEditIcon(".card-header","#inputType","#typeEdit");n.onClickEditIcon("#typeEdit","#skillType","#inputType");n.onEditUnfocus("#inputType","#skillType")},u=function(){n.toggleEditIcon(".card-title","#inputName","#nameEdit");n.onClickEditIcon("#nameEdit","#skillName","#inputName");n.onEditUnfocus("#inputName","#skillName")},f=function(){n.toggleEditIcon(".description","#inputDescription","#descriptionEdit");n.onClickEditIcon("#descriptionEdit","#skillDescription","#inputDescription");n.onEditUnfocus("#inputDescription","#skillDescription")},e=function(t){t?$("#disableSkill").show():$("#enableSkill").show();$("#discardChanges").click(function(){location.reload()});n.onInputChange("#inputType","#submitChanges","#discardChanges");n.onInputChange("#inputName","#submitChanges","#discardChanges");n.onInputChange("#inputDescription","#submitChanges","#discardChanges");n.onInputChange(".form-check","#submitChanges","#discardChanges")},o=function(){n.toggleModal("green","Skill updated")},s=function(t,i,r){var u=t.status+": "+t.statusText;n.toggleModal("red","Skill not updated!"+r+u)},h=function(n){var i=[];t.getSkillPatchDocument(i);$("#submitChanges").click(function(r){t.getJobSkillsPatchDocument(i);t.patchSkill(n,i,o,s);$("#submitChanges").hide();$("#discardChanges").hide();r.preventDefault()})},c=function(){n.toggleModal("green","Skill disabled");$("#disableSkill").hide();$("#enableSkill").show()},l=function(t,i,r){var u=t.status+": "+t.statusText;n.toggleModal("red","Skill not disabled!"+r)},a=function(n){var i=t.getSkillDisablePatchDocument();$("#disableSkill").click(function(r){t.getJobSkillsPatchDocument(i);t.patchSkill(n,i,c,l);r.preventDefault()})},v=function(){n.toggleModal("green","Skill enabled");$("#disableSkill").show();$("#enableSkill").hide()},y=function(t,i,r){var u=t.status+": "+t.statusText;n.toggleModal("red","Skill not enabled!"+r)},p=function(n){var i=t.getSkillEnablePatchDocument();$("#enableSkill").click(function(r){t.getJobSkillsPatchDocument(i);t.patchSkill(n,i,v,y);r.preventDefault()})},w=function(n){a(n);p(n)},b=function(i){var u=function(){n.toggleModal("green","Skill deleted");r()},f=function(t,i,u){n.toggleModal("red","Skill not deleted!"+u);r()},r=function(){setTimeout(function(){window.location.href="https://localhost:44375/Skills/AllSkills"},2500)},e=function(){t.deleteSkill(i,u,f)};$("#deleteSkill").click(function(){n.deleteToggleModal("this skill",e)})};return{animations:i,updateSkill:h,toggleSkillStatus:w,deleteSkill:b}}(PageElementHelpers,SkillService),EmployeesController=function(n,t,i){var r=function(n,t){n.on("select deselect",function(){var t=n.rows({selected:!0}).count();t>0?($("#deleteEmployees").show(),$("#deleteEmployees").text(t>1?"Delete Selected":"Delete"),t==1?$("#editEmployee").show():$("#editEmployee").hide()):($("#editEmployee").hide(),$("#deleteEmployees").hide())});$("#editEmployee").click(function(){n.$("tr.selected").each(function(){var i=n.row(this).data();location.href=t+"/"+i.id})})},u=function(){var i=function(n){$.each(n,function(t){n[t].type==="Soft"?$("#softSkills").append('<option value="'+n[t].id+'" data-id="'+n[t].id+'">'+n[t].name+"<\/option>"):n[t].type==="Technical"&&$("#techSkills").append('<option value="'+n[t].id+'" data-id="'+n[t].id+'">'+n[t].name+"<\/option>");$("#skillFilter").multiselect("rebuild")})},r=function(t,i,r){n.toggleModal("red","Skills Filter not rendered! "+r)};$("#skillFilter").multiselect({enableClickableOptGroups:!0,includeSelectAllOption:!0,buttonWidth:"30%",nonSelectedText:"Filter by Skill(s)"});t.getSkills(i,r)},f=function(n,t){$("#skillFilter").on("change",function(){var u=$(this).find("option:selected",this),i=[],r;u.each(function(){thisVal=$(this).val();i.find(n=>n===$(this).data("id"))||i.push($(this).data("id"))});r=i.join(",");n.destroy();n=EmployeesController.allEmployeesInit("#allEmployees",r,t);EmployeesController.animations(n,t);EmployeesController.deleteMultipleEmployees(n)})},e=function(n,t,r){var u=$(n).DataTable({ajax:i.getAllEmployeesDatatable(t),columnDefs:[{targets:0,data:null,defaultContent:"",orderable:!1,className:"select-checkbox"},{targets:1,data:"name"},{targets:2,data:"surname"},{targets:3,data:"hiringDate",render:function(n){return moment(n).format("dddd, MMMM Do, YYYY")}},{targets:4,data:"department"},{targets:5,data:"job"},{targets:6,data:"id",render:function(n,t,i){return'<a href="'+r+"/"+i.id+'">Details<\/a>'}}],select:{style:"multi",selector:"td:first-child"},order:[[1,"asc"]]});$(n).on("click","#select_all",function(){$("#select_all:checked").val()==="on"?u.rows().select():u.rows().deselect()});return u},o=function(i){var r=function(){var r=function(t){var i=[],r,u;$.each(t,function(n){i.push({skillId:t[n].id})});r=function(){n.toggleModal("green","Employee created")};u=function(t,i,r){n.toggleModal("red","Employee not created!"+r)};EmployeeService.postEmployee(i,r,u)},u=function(t,i,r){n.toggleModal("red","Could not get new skills!"+r)},f=i.map(n=>n.name),e=f.toString();t.getSkillsByName(e,r,u)},u=function(t,i,r){n.toggleModal("red","New Skills not created!"+r)};$("#submitEmployeeForm").click(function(){if($(".soft").has(".newSkills").length||$(".technical").has(".newSkills").length)t.postSkillCollection(i,r,u);else{var f=function(){n.toggleModal("green","Employee created")},e=function(t,i,r){n.toggleModal("red","Employee not created!"+r)};EmployeeService.postEmployee([],f,e)}setTimeout(function(){window.location.href="https://localhost:44375/Employees/AllEmployees"},2500)})},s=function(t){var u=function(){PageElementHelpers.toggleModal("green","Employees successfully deleted!");r()},f=function(t,i,u){n.toggleModal("red","Employees not deleted!"+u);r()},r=function(){setTimeout(function(){window.location.href="https://localhost:44375/Employees/AllEmployees"},2500)},e=function(){var n=i.getSelectedEmployeesIds(t);i.deleteEmployeesCollection(n,u,f)};$("#deleteEmployees").click(function(){n.deleteToggleModal("these employees",e)})};return{animations:r,skillsFilterCheckboxesInit:u,skillsFilterCheckboxesOnChange:f,allEmployeesInit:e,createEmployee:o,deleteMultipleEmployees:s}}(PageElementHelpers,SkillService,EmployeeService),EmployeeDetailsController=function(n,t){var i=function(){r();u();f();e();o()},r=function(){n.toggleEditIcon(".card-header","#inputEmpName","#nameEmpEdit");n.toggleEditIcon(".card-header","#inputEmpSurname","#nameEmpEdit");$("#nameEmpEdit").on("click",function(){$("#nameEmpEdit").hide();$("#employeeName").css({display:"none"});$("#employeeSurname").css({display:"none"});$("#inputEmpName").css({display:"inline-block"});$("#inputEmpSurname").css({display:"inline-block"});$("#inputEmpName").focus();$("#inputEmpName").val($("#employeeName").html());$("#inputEmpSurname").val($("#employeeSurname").html());$(document).mouseup(function(n){$(".card-header").is(n.target)||$(".card-header").has(n.target).length!==0||($("#employeeName").html($("#inputEmpName").val()),$("#inputEmpName").css({display:"none"}),$("#employeeName").css({display:"inline-block","margin-top":"2px"}),$("#employeeSurname").html($("#inputEmpSurname").val()),$("#inputEmpSurname").css({display:"none"}),$("#employeeSurname").css({display:"inline-block","margin-top":"2px"}))})})},u=function(){n.toggleEditIcon(".card-header","#inputType","#typeEdit");n.onClickEditIcon("#typeEdit","#skillType","#inputType");n.onEditUnfocus("#inputType","#skillType")},f=function(){n.toggleEditIcon(".phone","#inputEmpPhone","#phoneEmpEdit");n.onClickEditIcon("#phoneEmpEdit","#employeePhone","#inputEmpPhone");n.onEditUnfocus("#inputEmpPhone","#employeePhone")},e=function(){n.toggleEditIcon(".email","#inputEmpEmail","#emailEmpEdit");n.onClickEditIcon("#emailEmpEdit","#employeeEmail","#inputEmpEmail");n.onEditUnfocus("#inputEmpEmail","#employeeEmail")},o=function(){$("#discardEmpChanges").click(function(){location.reload()});n.onInputChange("#inputEmpName","#submitEmpChanges","#discardEmpChanges");n.onInputChange("#inputEmpSurname","#submitEmpChanges","#discardEmpChanges");n.onInputChange("#inputEmpPhone","#submitEmpChanges","#discardEmpChanges");n.onInputChange("#inputEmpEmail","#submitEmpChanges","#discardEmpChanges");n.onInputChange(".form-check","#submitEmpChanges","#discardEmpChanges")},s=function(i){var u=function(){n.toggleModal("green","Employee updated");setTimeout(function(){location.reload()},2500)},f=function(t,i,r){var u=t.status+": "+t.statusText;n.toggleModal("red","Employee not updated!"+r+u)},r=[];t.getEmployeePatchDocument(r);$("#submitEmpChanges").click(function(n){t.getEmployeeSkillsPatchDocument(r);t.patchEmployee(i,r,u,f);$("#submitEmpChanges").hide();$("#discardEmpChanges").hide();n.preventDefault()})},h=function(i){var u=function(){n.toggleModal("green","Employee deleted");r()},f=function(){n.toggleModal("red","Employee not deleted!"+errorThrown);r()},r=function(){setTimeout(function(){window.location.href="https://localhost:44375/Employees/AllEmployees"},2500)},e=function(){t.deleteEmployee(i,u,f)};$("#deleteEmployee").click(function(){n.deleteToggleModal("this employee",e)})};return{animations:i,updateEmployee:s,deleteEmployee:h}}(PageElementHelpers,EmployeeService);$(document).on("click",".nav-link",function(){$(".nav-item").find(".active").removeClass("active")});$(document).ready(function(){$('a[href="'+location.pathname+'"]').closest(".nav-item").addClass("active")});