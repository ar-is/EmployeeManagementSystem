...
namespace EmployeeManagementSystem.API.Infrastructure.Migrations
{
    ...
    [Migration("20200214121400_AddIsEnabledToSkillAndSkillJob")]
    partial class AddIsEnabledToSkillAndSkillJob
    {
            ...
            modelBuilder.Entity("EmployeeManagementSystem.API.Core.Entities.Employee", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("LatestSkillsetUpdate")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HiringDate = new DateTimeOffset(new DateTime(2019, 9, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            JobId = (short)3,
                            LatestSkillsetUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LatestUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "Georgios",
                        ...
                        new
                        {
                            ...
                            HiringDate = new DateTimeOffset(new DateTime(2017, 4, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            JobId = (short)5,
                            LatestSkillsetUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LatestUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "Dimitrios",
                        ...
                        new
                        {
                            ...
                            HiringDate = new DateTimeOffset(new DateTime(2017, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            JobId = (short)2,
                            LatestSkillsetUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LatestUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "Eleni",
                        ...
                        new
                        {
                            ...
                            HiringDate = new DateTimeOffset(new DateTime(2017, 8, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            JobId = (short)4,
                            LatestSkillsetUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LatestUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "John",
                        ...
                        new
                        {
                            ...
                            HiringDate = new DateTimeOffset(new DateTime(2020, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            JobId = (short)6,
                            LatestSkillsetUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LatestUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "Konstantina",
                        ...
                        new
                        {
                            ...
                            HiringDate = new DateTimeOffset(new DateTime(2017, 3, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            JobId = (short)3,
                            LatestSkillsetUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LatestUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "Amy",
                        ...
                        new
                        {
                            ...
                            HiringDate = new DateTimeOffset(new DateTime(2019, 5, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            JobId = (short)3,
                            LatestSkillsetUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LatestUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "Petros",
                        ...
                        new
                        {
                            ...
                            HiringDate = new DateTimeOffset(new DateTime(2019, 3, 27, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            JobId = (short)1,
                            LatestSkillsetUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            LatestUpdate = new DateTimeOffset(new DateTime(2020, 1, 30, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            Name = "Katerina",
